...
import { Loader, Clipboard, Download, ChevronLeft, ChevronRight, Settings, Plus, Minus } from 'lucide-react';
      ...
      <div className="h-48 bg-gray-200 flex items-center justify-center relative">
        ...
        <div className="flex-grow">
          ...
          <div className="text-xs space-y-1">
            ...
            {sanitizeValue(product.brand) && <p><strong>Brand:</strong> {sanitizeValue(product.brand)}</p>}
            {sanitizeValue(product.category) && <p><strong>Category:</strong> {sanitizeValue(product.category)}</p>}
          </div>
...
useEffect(() => {
    if (minQtyRef.current === document.activeElement) {
        minQtyRef.current.focus();
    }
}, [minQty]);

useEffect(() => {
    if (maxQtyRef.current === document.activeElement) {
