...
export default function OdooProductCardGenerator() {
  ...
  return (
    <div className="w-screen min-h-screen bg-gray-50 dark:bg-gray-900 font-inter">
      <NavBar />
      <div className="w-full">
       ...
       <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 overflow-y-visible">
        ...
        <div className={`sticky top-20 z-40 transition-all duration-300 ${isSticky ? 'bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm shadow-xl border-b border-gray-200 dark:border-gray-700 py-4' : 'bg-transparent'}`}>

            <div className={`bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300 ${isSticky ? 'shadow-2xl scale-[0.98]' : ''}`}>
