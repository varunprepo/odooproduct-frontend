        ...
        <div className="w-full bg-white border-b border-gray-200">
          <form onSubmit={handleSearchSubmit} className="w-full max-w-7xl mx-auto p-5">
            <input
              ...
              placeholder={`Search (min ${MIN_SEARCH_LENGTH} chars for API Search product (SKU, Barcode, or Name)...`}
              className="w-full border border-black p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150"
            />
          </form>
        </div>
